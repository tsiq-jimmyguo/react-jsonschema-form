...
var ArrayField = function (_Component) {
  ...
  function ArrayField() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref3 = ArrayField.__proto__ || (0, _getPrototypeOf2.default)(ArrayField)).call.apply(_ref3, [this].concat(args))), _this), _this.onAddClick = function (event) {
      ...
      return function (value, errorSchema) {
        ...
        var jsonValue = value === undefined ? null : value;
  ...
  (0, _createClass3.default)(ArrayField, [{
    ...
    value: function render() {
      ...
      if ((0, _utils.isForm)(schema)) {
        var isFormWithoutItems = !schema.items;

        var isDefinedForm = Array.isArray(schema.items) && schema.items[0] && schema.items[0].type === "object";

        var isDefinedFormWithEmptyProperties = isDefinedForm && !(0, _keys2.default)(schema.items[0].properties).length;
        ...
        if (isFormWithoutItems || isDefinedFormWithEmptyProperties) {
          ...
          return _react2.default.createElement(_BooleanField2.default, (0, _extends4.default)({}, this.props, {
    ...
    value: function renderNormalArray(schema) {
      var _this2 = this;
    ...
    value: function renderMultiSelect(schema) {
    ...
    key: "renderFiles",
    value: function renderFiles(schema) {
    ...
    value: function renderFixedArray(schema) {
      var _this3 = this;
      ...
      if ((0, _utils.isForm)(schema)) {
        var _schema$minItems = schema.minItems,
            minItems = _schema$minItems === undefined ? 0 : _schema$minItems;


        if (required && (0, _utils.isForm)(schema) && (!items || items.length < minItems)) {
          items = items || [];
        ...
        if (!items || items.length < itemSchemas.length) {
          ...
          items = items || [];
          items = items.concat(new Array(itemSchemas.length - items.length).fill());
        }
      }
